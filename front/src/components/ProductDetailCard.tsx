  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center bg-[#192B45] p-4 sm:p-6 md:p-8">
        <div className="flex flex-col md:text-left text-center md:flex-row items-center text-blue-50 bg-gray-900/70 rounded-2xl shadow-lg overflow-hidden w-full max-w-7xl h-auto md:min-h-[70vh]">
          <div className="w-full md:w-1/2  p-6 sm:p-8 md:p-10 flex flex-col justify-center">
            ...
            <div className="flex justify-center md:justify-start items-center text-blue-500 mb-4 sm:mb-6">
              {Array(4)
                .fill(0)
                .map((_, i) => (
            ...
            <button
              ...
              className="w-[fit-content] mx-auto md:mx-0 border border-transparent hover:bg-transparent bg-blue-800 text-blue-50 hover:border-blue-50 cursor-pointer flex items-center gap-1 px-6 sm:px-8 py-2 sm:py-3 rounded-full font-semibold text-base sm:text-lg transition"
            >
              <span>Add</span>
