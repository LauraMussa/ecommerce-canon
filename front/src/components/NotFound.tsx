  ...
  return (
    <div className=" text-blue-50 min-h-screen bg-[url('/images/NotFound.png')] bg-center bg-cover bg-no-repeat">
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <h2 className=" text-[3em] md:text-[8rem] font-bold text-center">Page not found</h2>
        <p className="mb-8 text-xl tracking-wider font-bold text-gray-300/70 text-center">
